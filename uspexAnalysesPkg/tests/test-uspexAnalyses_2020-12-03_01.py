...
fileOrDirectoryName = r'D:\cadarp02\Documents\Modeling\USPEX\AsTe3\AsTe3_Z-8_vaspPBE_201029\results1'
...
fig1 = usd.plot_enthalpies(usd.get_structure_IDs(bestStructures=50),
...
fig2 = usd.distMatrixData.plot_distance_matrix()

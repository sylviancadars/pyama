...
class AtomEnvComparisonsData(BaseDataClass):
    ...
    def __init__(self, average_kernel_metric='polynomial', average_kernel_degree=3,
                 soap_r_cut=5.0, soap_n_max=8, soap_l_max=8, soap_sigma=0.6,
    ...
    def get_similary_maps_by_type(self, system_1, system_2,
        ...
        desc_1 = SOAP(species=species, r_cut=self.soap_r_cut, n_max=self.soap_n_max,
                    l_max=self.soap_l_max, sigma=self.soap_sigma,
                    periodic=periodic_1, rbf=self.soap_rbf,
                    compression=self.soap_compression, sparse=self.soap_sparse)

        desc_2 = SOAP(species=species, r_cut=self.soap_r_cut, n_max=self.soap_n_max,
                    l_max=self.soap_l_max, sigma=self.soap_sigma,

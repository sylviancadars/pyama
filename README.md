...
Currently-implemented modules and packages :
- utils moduele contains a number of functions to facilitate convertion to ASE Atoms or Pymatgen structure, visualize structures, etc.
...
- diffractionPkg : tools to calculate atomic form factors, and caculate exact X-ray total scattering data
...
- ceramicNetworkBuilder : build a ceramic network atom-by atom with coordinance and clustering probabilities.
	Contributors: 
		* Fabien Mortier, Institut de Recherche sur les Ceramiques, CNRS, Universite de Limoges, France
		* Assil Bouzid, Institut de Recherche sur les Ceramiques, CNRS, Universite de Limoges, France
